class PedidosViewModel {
  ...
  String? even_FechaInicio;
  String? even_FechaFin;
  String? even_Sexo;
  String? util_IdList;
  ...
  factory PedidosViewModel.fromJson(Map<String, dynamic> json) =>
      PedidosViewModel(
        ...
        Clie_Fecha_Creacion: json['clie_Fecha_Creacion'] != null
            ? DateTime.parse(json['clie_Fecha_Creacion'])
            : null,
        ...
        even_FechaInicio: json['even_FechaInicio'],
        even_FechaFin: json['even_FechaFin'],
