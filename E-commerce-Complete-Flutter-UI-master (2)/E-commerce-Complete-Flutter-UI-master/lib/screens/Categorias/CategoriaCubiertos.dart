...
class CategoriaCubiertos extends StatefulWidget {
  static const String routeName = '/categoria_cubiertos';

  const CategoriaCubiertos({Key? key}) : super(key: key);

  @override
  State<CategoriaCubiertos> createState() => _CategoriaCubiertosState();
}
